          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div className="text-center">
              <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-heart text-2xl text-uh-red"></i>
              </div>
              <h3 className="text-xl font-bold text-uh-black mb-3">Heartbeats</h3>
              <p className="text-gray-600 mb-6">Find love and meaningful connections within the Cougar community</p>
              <Link href="/forums/categories/24">
                <Button className="w-full bg-uh-red hover:bg-red-700">
                  Join Heartbeats
                </Button>
              </Link>
            </div>
