    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-uh-black mb-2">Latest News</h1>
          <p className="text-sm sm:text-base text-gray-600">Stay up to date with University of Houston athletics and campus news</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {newsArticles.map((article: any) => (
              <Card key={article.id} className="h-full overflow-hidden hover:shadow-lg transition-shadow cursor-pointer flex flex-col">
                <div className="aspect-[16/9] overflow-hidden bg-gray-100">
                  <img
                    src={article.imageUrl || "https://images.unsplash.com/photo-1577223625816-7546f13df25d?w=800&h=450&fit=crop"}
                    alt={article.title}
                ...
                <div className="p-4 sm:p-6 flex flex-col flex-1">
                  ...
                  <div className="mt-auto flex items-center justify-between gap-3 text-xs text-gray-500">
          ...
          <Card className="p-8 sm:p-12">
            <div className="text-center text-gray-500">
              <i className="fas fa-newspaper text-5xl sm:text-6xl mb-6"></i>
