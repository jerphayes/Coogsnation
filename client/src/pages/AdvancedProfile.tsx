        ...
        <div className="bg-gradient-to-r from-uh-red to-red-700 rounded-lg p-8 mb-8 text-white">
          <div className="flex items-center space-x-6">
            <Avatar className="w-24 h-24 border-4 border-white">
              <AvatarImage src={userProfile?.avatarUrl} alt={profileDisplayName} />
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        type="email"
                        value={userProfile?.email || (user as any)?.email || ""}
                        disabled
                        readOnly
                      />
                      <p className="text-sm text-gray-600">
                        Email changes use the account-security workflow and cannot be made through profile editing.
                      </p>
                    </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
                  <p className="font-medium text-amber-900">Privacy controls are being finalized.</p>
                  <p className="mt-1 text-sm text-amber-800">
                    The previous switches were not connected to persisted account settings, so they have been disabled until database-backed privacy controls are implemented and tested.
                  </p>
                </div>
              </CardContent>
            </Card>
